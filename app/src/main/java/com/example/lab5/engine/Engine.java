...
public class Engine {
    ...
    //потом будет в бесконечном цикле т.е. постоянно обновлять картинку и отрисовывать модель
    ...
    public Engine(SurfaceView surfaceView){
        ...
        Thread engineThread = new Thread(threadRunnable, "EngineThred");
        engineThread.start();
